...
import ModalCalculo, { valorAplicado } from "./ModalCalculo";
    ...
    "
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          <Cards
            ...
            description={`(${data?.dados.vendasRealizadas} vendas × R$ ${valorAplicado(data?.dados.vendasRealizadas!)}) = ${formatCurrency(data?.dados.rvBase)}`}
          />
          <Cards
            title="Bonificações"
