                ...
                <div className="p-6 space-y-6 text-sm text-zinc-600 dark:text-zinc-300">
                    ...
                    <section>
                        ...
                        <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800/40 p-4 rounded-xl space-y-1.5">
                            <p>• 9 vendas → R$ 10,00 por venda = <span className="font-semibold">R$ 90,00</span></p>
                            <p>• 10 vendas → muda de faixa → R$ 20,00 por venda = <span className="font-semibold">R$ 200,00</span></p>
                            <p>• 11 vendas → <span className="font-semibold">R$ 220,00</span></p>
