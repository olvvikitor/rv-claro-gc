...
const IndicatorsSectionUP: React.FC<IndicatorsSectionProps> = ({ data, loading, error }) => {
    if (loading) {
        return (
    ...
    return (
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
            <Cards
                title="Meta"
                value={data.dados.meta.toString()}
                color="green"
            ...
            <Cards
                title="Faixa Atual"
                value={data.dados.metaPercentual + '%'}
                color="green"
...
export default IndicatorsSectionUP;
